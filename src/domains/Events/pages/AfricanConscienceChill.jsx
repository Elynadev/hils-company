...
const AfricanConscienceChill = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero */}
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-acc-primary via-acc-secondary to-acc-dark">
        ...
        <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
          ...
          >
            <span className="w-2 h-2 rounded-full bg-acc-accent animate-pulse" />
          ...
          >
            African Conscience
            <br />
            <span className="text-acc-accent">Chill</span>
          </motion.h1>
          ...
          >
            {[
              ...
              <div key={stat.label} className="text-center">
                <div className="text-3xl font-black text-acc-accent" style={{ fontFamily: "'Playfair Display', serif" }}>
                  {stat.nb}
                </div>
      ...
      <section className="py-24 bg-bg px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-acc-secondary font-bold text-sm uppercase tracking-widest">Le Concept</span>
            <h2 className="text-4xl md:text-5xl font-black text-primary mt-3 mb-5" style={{ fontFamily: "'Playfair Display', serif" }}>
              Un Événement <span className="text-acc-primary">Unique</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                {[
                  ...
                  return (
                    <div key={index} className="flex items-center gap-3 p-4 bg-white rounded-2xl border-2 border-primary/10">
                      <div className="w-10 h-10 rounded-xl bg-acc-primary/10 flex items-center justify-center">
                        <Icon size={20} className="text-acc-primary" />
                      </div>
            ...
            <div className="relative">
              <div className="absolute inset-0 bg-gradient-to-r from-acc-primary to-acc-dark rounded-3xl transform rotate-3 opacity-20"></div>
      ...
      <section className="py-24 bg-white px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-acc-secondary font-bold text-sm uppercase tracking-widest">Notre Mission</span>
            <h2 className="text-4xl md:text-5xl font-black text-primary mt-3 mb-5" style={{ fontFamily: "'Playfair Display', serif" }}>
              Cible & <span className="text-acc-primary">Objectifs</span>
            </h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={index} className="flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-acc-primary flex items-center justify-center text-white text-xs font-bold mt-0.5">✓</span>
            ...
            <div className="bg-acc-primary/5 rounded-3xl p-8 border-2 border-acc-primary/20">
              <h3 className="text-2xl font-black text-primary mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
                Nos Objectifs
              </h3>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={index} className="flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-acc-dark flex items-center justify-center text-white text-xs font-bold mt-0.5">★</span>
                    <span className="text-gray-700">{item}</span>
                  </li>
                ))}
              </ul>
      ...
      <section className="py-24 bg-bg px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <span className="text-acc-secondary font-bold text-sm uppercase tracking-widest">Notre Histoire</span>
            <h2 className="text-4xl md:text-5xl font-black text-primary mt-3 mb-5" style={{ fontFamily: "'Playfair Display', serif" }}>
              Éditions <span className="text-acc-primary">Précédentes</span>
            </h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {editions.map((edition, index) => (
              <div key={index} className="bg-white rounded-3xl p-8 border-2 border-acc-primary/20 hover:border-acc-primary hover:shadow-2xl transition-all duration-300">
                <div className="text-6xl font-black text-acc-primary mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
                  {edition.year}
                </div>
      ...
      {/* CTA */}
      <section className="py-24 bg-gradient-to-br from-acc-primary to-acc-dark relative overflow-hidden px-6">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white mb-6 leading-tight" style={{ fontFamily: "'Playfair Display', serif" }}>
            ...
            <br />
            <span className="text-acc-accent">édition</span>
          </h2>
