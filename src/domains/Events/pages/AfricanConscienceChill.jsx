...
import { Users, Target, Calendar, Handshake, Home } from "lucide-react";
...
const AfricanConscienceChill = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero */}
      <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  return (
                    <div key={index} className="flex items-center gap-3 p-4 bg-white rounded-2xl border-2 border-orange-100">
                      <div className="w-10 h-10 rounded-xl bg-orange-100 flex items-center justify-center">
                        <Icon size={20} className="text-orange-600" />
                      </div>
                      <span className="text-sm font-bold text-orange-700">{item.label}</span>
                    </div>
                  );
                })}
              </div>
            ...
            <div className="relative">
              ...
              <div className="relative rounded-3xl overflow-hidden h-96 shadow-2xl">
                <img src={heroImg} alt="African Conscience Chill" className="w-full h-full object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-orange-600/80 to-transparent flex items-end justify-center p-8">
                  <div className="text-center">
                    <p className="text-white font-bold text-lg">Photos & Vidéos</p>
                    <p className="text-white/80 text-sm">Éditions précédentes</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-orange-50 rounded-3xl p-8 border-2 border-orange-200">
              <h3 className="text-2xl font-black text-orange-700 mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
                Notre Cible
              </h3>
            ...
            <div className="bg-orange-50 rounded-3xl p-8 border-2 border-orange-200">
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={index} className="flex items-start gap-3">
                    <span className="w-6 h-6 rounded-full bg-secondary flex items-center justify-center text-white text-xs font-bold mt-0.5">★</span>
                    <span className="text-gray-700">{item}</span>
                  </li>
                ))}
              </ul>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {editions.map((edition, index) => (
              <motion.div
                ...
                className="group bg-white rounded-3xl overflow-hidden border-2 border-orange-200 hover:border-orange-500 hover:shadow-2xl transition-all duration-300"
              >
                <div className="h-48 overflow-hidden relative">
                  <img src={edition.image} alt={edition.theme} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                ...
                <div className="p-6">
                  <div className="text-2xl font-bold text-orange-600 mb-2">{edition.participants}</div>
                  <h3 className="text-lg font-black text-orange-700 mb-2">{edition.theme}</h3>
      ...
      {/* CTA */}
      <section className="py-24 bg-gradient-to-br from-orange-500 via-orange-600 to-orange-700 relative overflow-hidden px-6">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-white mb-6 leading-tight" style={{ fontFamily: "'Playfair Display', serif" }}>
            ...
            <br />
            <span className="text-yellow-300">édition</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button className="px-10 py-4 bg-white text-orange-600 font-black rounded-full hover:scale-105 hover:shadow-xl transition-all duration-300">
